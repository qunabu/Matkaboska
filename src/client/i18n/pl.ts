const pl = {
  ...
  settings: {
    ...
    notifyIntervalHint: 'Wszystko, co zbierze się w tym czasie, przychodzi razem — każda rzecz z własnym przyciskiem („Zrobione", „Przyjąłem", „Tak/Nie"), więc odhaczysz ją bez otwierania aplikacji.',
