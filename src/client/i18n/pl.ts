const pl = {
  ...
  onboarding: {
    ...
    intro: 'Podaj przynajmniej 10 dań, które lubisz jeść. Potem otworzysz Claude lub ChatGPT z gotowym promptem, który wygeneruje JSON — wklejasz go tutaj i importujesz.',
    targetsTitle: 'Twoje cele dzienne',
    kcal: 'Kalorie (kcal)',
    protein: 'Białko (g)',
    dishesTitle: '1. Twoje dania',
    dishPlaceholder: 'np. Owsianka z owocami',
    addDish: '+ Dodaj danie',
    counter: (n: number) => `${n}/10 dań`,
    needMore: 'Podaj jeszcze przynajmniej 10 dań.',
    genStep: '2. Wygeneruj przepisy',
    genHint: 'Otwórz asystenta z gotowym promptem (jeśli się nie wklei — użyj „Kopiuj prompt" i wklej ręcznie). Skopiuj CAŁĄ odpowiedź (razem z blokiem kodu) — sam wyciągnę z niej JSON.',
    openClaude: '💬 Otwórz w Claude',
    openChatgpt: '💬 Otwórz w ChatGPT',
    copyPrompt: '📋 Kopiuj prompt',
    copied: '✓ Skopiowano',
    pasteStep: '3. Wklej JSON i importuj',
    pastePlaceholder: 'Wklej tutaj całą odpowiedź asystenta (może być z blokiem ```json```)…',
    importBtn: '📥 Importuj przepisy',
    importing: 'Importuję…',
    jsonInvalid: 'To nie jest poprawny JSON. Wklej tablicę przepisów wygenerowaną przez asystenta.',
    error: 'Nie udało się zaimportować. Sprawdź JSON i spróbuj ponownie.',
    doneTitle: 'Gotowe!',
  ...
  settings: {
    ...
    notifyInterval: 'Jak często powiadamiać',
    notifyIntervalHint: 'Wszystko, co zbierze się w tym czasie, przychodzi razem — każda rzecz z własnym przyciskiem („Zrobione", „Przyjąłem", „Tak/Nie"), więc odhaczysz ją bez otwierania aplikacji. Każda rzecz przychodzi tylko raz: nieodhaczona nie jest ponawiana, wróci dopiero przy następnym terminie.',
    notifyIntervalOff: 'Bez ograniczeń',
    quietHours: 'Godziny ciszy',
    quietHoursHint: 'W tych godzinach telefon milczy. Nic nie przepada — czeka na pierwsze powiadomienie po ciszy.',
    quietFrom: 'Od',
    quietTo: 'Do',
    pushDevices: 'Zarejestrowane urządzenia',
    pushDevicesNone: 'Serwer nie widzi tego urządzenia — dlatego powiadomienia milczą. Tapnij „Odśwież rejestrację".',
    pushLastBatch: 'Ostatnia partia',
    pushNever: 'jeszcze nic nie wysłano',
    pushRefresh: 'Odśwież rejestrację',
    pushRefreshed: 'Zarejestrowano ponownie ✓',
    pushRefreshFailed: 'Nie udało się zarejestrować — sprawdź, czy powiadomienia są włączone w ustawieniach telefonu.',
    saved: 'Zapisano',
  ...
  today: {
    ...
    ownFoodHint: 'Zacznij pisać — Matka Boska podpowie z jadłospisu i z tego, co już wyznałaś/eś.',
    sugFromLog: 'wcześniej',
    sugFromRecipe: 'jadłospis',
    sugNoMacros: 'oszacuję makro',
    sugEmpty: 'Nic nie znaleziono — Matka Boska oszacuje makro z opisu.',
    sugAdding: 'Dodaję…',
    ...
    dayLabel: 'Na który dzień?',
    yesterdayNotice: 'Dodajesz do wczorajszego dnia',
    loggedYesterday: 'Zjedzone wczoraj',
    mKcal: 'kcal',
    mProtein: 'B (g)',
    mCarbs: 'W (g)',
    mFat: 'T (g)',
  ...
  plan: {
    ...
    swap: 'Zamień na coś innego',
    swapBatch: 'Zamień na coś innego (w obu dniach bloku)',
    swapNoAlternative: 'Brak innego dania w tej kategorii.',
    swapNotRecipe: 'Tę pozycję można tylko usunąć — to produkt, nie przepis.',
    swapDone: (title: string) => `Zamieniono na: ${title}`,
    leftover: 'resztki',
  ...
  shopping: {
    ...
    friscoSearchTitle: 'Szukaj i dodaj z Frisco',
    friscoSearchPlaceholder: 'Nazwa produktu…',
    friscoSearchError: 'Nie udało się wyszukać. Sprawdź dane logowania Frisco w Ustawieniach.',
    friscoNoResults: 'Brak wyników w Frisco.',
    friscoAvailable: 'dostępny',
    friscoUnavailable: 'niedostępny',
    friscoBlocked: 'zablokowany (reguła)',
    friscoAddToCart: 'Do koszyka',
    ...
    pasteBtn: 'Wklej listę',
    pasteTitle: 'Wklej tekst — zamienię go w pozycje',
    pasteHint: 'Wklej cokolwiek: SMS-a od żony, przepis, notatkę z kartki. Rozbiję to na osobne pozycje z ilościami — tak jakbyś wpisał je jedna po drugiej.',
    pastePlaceholder: 'np.\n2 kg mąki, mleko 3 szt\n- pomidory\n- 250 g masła',
    pasteParse: 'Rozpoznaj pozycje',
    pasteParsing: 'Rozpoznaję…',
    pasteParsedBySplit: 'Bez klucza API rozbiłem tekst po linijkach i przecinkach — dodaj klucz w Ustawieniach, żeby rozpoznawać ilości dokładniej.',
    pasteNothing: 'Nie znalazłem w tym żadnych produktów. Popraw tekst i spróbuj ponownie.',
    pasteReview: (n: number) => `Znalazłem ${n} pozycji — odznacz te, których nie chcesz.`,
    pasteDuplicate: 'już na liście',
    pasteSelectAll: 'Zaznacz wszystkie',
    pasteSelectNone: 'Odznacz wszystkie',
    pasteConfirm: (n: number) => `Dodaj ${n} pozycji`,
    pasteAdding: 'Dodaję…',
    pasteBack: 'Popraw tekst',
  },
  ...
  blocks: {
    ...
    add: 'Dodaj blokadę',
    empty: 'Brak blokad. Dodaj pierwszą stronę lub aplikację.',
    always: 'zawsze blokowana',
    perDay: 'min dziennie',
    inactive: 'wyłączona',
    deleteConfirm: 'Usunąć tę blokadę?',
    emergency: 'dostęp awaryjny',
    emergencyOn: 'Wyłącz dostęp awaryjny',
    emergencyOff: 'Włącz dostęp awaryjny',
    emergencyHint: 'Reguła z dostępem awaryjnym ma na ekranie blokady przycisk, który odblokowuje ją na 5 minut bez odhaczania nawyku. Każde użycie jest liczone i widać je niżej.',
    emergencyCount: 'Awaryjne',
    patternHelp: 'Sama nazwa („facebook") łapie facebook.com, m.facebook.com i facebook.co.uk. Z kropką („facebook.com") — dokładnie ta domena i jej subdomeny.',
    unlockHint: 'Na ekranie blokady telefon pokazuje dzisiejsze niezrobione nawyki. Odhaczenie jednego zapisuje wpis w Nawykach i odblokowuje stronę na 5 minut.',
    devices: 'Urządzenia',
    devicesHint: 'Telefon nie zaloguje się przez Google, więc dostaje własny token. Wklej go raz w aplikacji SiteLimit na Androidzie.',
    deviceNamePlaceholder: 'np. Pixel 9',
    addDevice: 'Dodaj urządzenie',
    noDevices: 'Brak urządzeń.',
    neverSeen: 'nigdy się nie łączyło',
    lastSeen: 'ostatnio',
    tokenOnce: 'Skopiuj ten token teraz — nie zobaczysz go ponownie.',
    copy: 'Kopiuj',
    copied: 'Skopiowano',
    deleteDeviceConfirm: 'Usunąć urządzenie? Straci dostęp natychmiast.',
  },
  ...
  tracking: {
    ...
    goals: 'Cele',
    progress: 'Postęp',
    avgTitle: 'Średnie dzienne',
    avgMonth: 'Ostatnie 30 dni',
    avgAll: 'Od początku',
    avgDays: 'dni z wpisami',
    avgEntries: 'wpisów',
    avgSince: 'od',
    avgTarget: 'cel',
    avgNoData: 'Za mało danych — dodaj wpisy w kilku dniach.',
    avgNote: 'Liczone tylko z dni, w których coś zapisałaś/eś. Dzisiejszy dzień nie wchodzi.',
    water: {
      title: 'Woda',
      glasses: 'Szklanek',
      target: 'Cel',
  ...
  habits: {
    title: 'Nawyki',
    hint: 'Raz dziennie push zapyta, czy nawyk się udał — o stałej godzinie, jeśli ją ustawisz, w przeciwnym razie o losowej porze. Treść pokaże serię (np. „już 5 dni 🔥").',
    ...
    reminderLabel: 'Przypomnienie o:',
    reminderRandom: 'losowa pora',
    reminderClear: 'wyczyść',
    suggestTitle: 'Dodaj gotowe nawyki:',
    todayCard: 'Nawyki dziś',
