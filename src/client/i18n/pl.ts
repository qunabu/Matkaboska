const pl = {
  ...
  onboarding: {
    ...
    genHint: 'Otwórz asystenta z gotowym promptem (jeśli się nie wklei — użyj „Kopiuj prompt" i wklej ręcznie). Skopiuj odpowiedź JSON.',
    openClaude: '💬 Otwórz w Claude',
    openChatgpt: '💬 Otwórz w ChatGPT',
    copyPrompt: '📋 Kopiuj prompt',
    copied: '✓ Skopiowano',
    pasteStep: '3. Wklej JSON i importuj',
    pastePlaceholder: 'Wklej tutaj tablicę JSON z przepisami…',
