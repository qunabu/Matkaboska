...
export const planApi = {
  ...
  generateWeek: (weekStart: string) =>
    req<{ inserted: number; cookingSessions: number; boosterEntries: number; topUps: number; avgKcal: number; avgProtein: number }>(`/plan/generate-week`, { method: 'POST', body: JSON.stringify({ weekStart }) }),
