...
export const planApi = {
  ...
  generateWeek: (weekStart: string) =>
    req<{ inserted: number; cookingSessions: number; boosterEntries: number; maxPerDay: number; avgPortion: number; avgKcal: number; avgProtein: number; avgIron: number }>(`/plan/generate-week`, { method: 'POST', body: JSON.stringify({ weekStart }) }),
