...
export const SEED_RULES: SeedRule[] = [
  ...
  R('CENTRUM PSYCHOLOGICZNE|PSYCHOLOG|PSYCHIATR|DERMATOLOG|MEDICOVER|LUX ?MED|ENEL-MED|CENTRUM MEDYCZNE|PRZYCHODNIA|STOMATOLOG|DENTYST|GINEKOLOG|OKULIST', 'zdrowie_opieka', null, false, 690),
